    ...
    fetch("json/brands_models_global.json")
        ...
        .then(brandModelData => {
            ...
            brandSelect.addEventListener("change", function () {
                ...
                modelSelect.innerHTML = `<option value="" data-i18n-key="select_model_first">Select a make first</option>`;
                typeSelect.innerHTML = `<option value="" data-i18n-key="select_model_first">Select a model first</option>`;
            ...
            modelSelect.addEventListener("change", function () {
                ...
                typeSelect.innerHTML = `<option value="" data-i18n-key="select_type">Select type</option>`;
                typeSelect.disabled = true;
    ...
    listingForm.addEventListener("submit", async (e) => {
        ...
        if (isEditMode) {
            ...
            const newListing = {
                ...
                state: loggedUser.state || "Unknown",
                images: {
