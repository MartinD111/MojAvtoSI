document.addEventListener("DOMContentLoaded", () => {
    ...
    const initialListings = [
        ...
        // Motorji
        { id: 5, type: "Motorji", make: "BMW Motorrad", model: "R 1250 GS", title: "BMW R 1250 GS Adventure", year: 2023, mileage: 5200, price: 21500, power: 100, fuel: "Petrol", transmission: "Ročni", region: "Gorenjska", phone: "040 111 222", images: { exterior: ["bmw_r1250gs_moto_1777103973226.png"], interior: [] } },
        { id: 6, type: "Motorji", make: "Honda", model: "CB 650R", title: "Honda CB 650R Neo Sports Cafe", year: 2022, mileage: 8400, price: 7900, power: 70, fuel: "Petrol", transmission: "Ročni", region: "Osrednjeslovenska", images: { exterior: ["honda_cb650r_moto_1777103989405.png"], interior: [] } },
        // Gospodarska vozila
        ...
        paginatedListings.forEach(listing => {
            ...
            card.innerHTML = `
                <div class="card-image-container">
                    <img src="${listing.images?.exterior[0] || 'https://via.placeholder.com/300x180?text=Vehicle'}" alt="${listing.title}" />
                ...
                <div class="card-body">
                    ...
                    <p class="card-details">${translate('spec_year')}: ${listing.year} | ${translate('spec_mileage')}: ${listing.mileage.toLocaleString('en-US')} mi</p>
                    <p class="card-price">$${listing.price.toLocaleString('en-US')}</p>
                </div>`;
    ...
    makeSelect.addEventListener("change", () => {
        ...
        modelSelect.innerHTML = `<option value="">${translate('all_models') || 'All models'}</option>`;
