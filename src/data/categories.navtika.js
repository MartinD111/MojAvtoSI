...
export const MAIN_CATEGORIES = {
    colni: {
        ...
        subcategories: {
            motorni_coln: {
                ...
                itemType: 'plovilo',
                vehicleTypes: [
                    { value: 'Gliser', label: 'vtype_bowrider' },
                    { value: 'KabinskiColn', label: 'vtype_cabin_cruiser' },
                    { value: 'KonzolniColn', label: 'vtype_center_console' },
                    { value: 'SportnaJahta', label: 'vtype_sport_yacht' },
                    { value: 'RibiskiColn', label: 'vtype_fishing_boat' },
                    { value: 'Ponton', label: 'vtype_pontoon' },
                    { value: 'Walkaround', label: 'vtype_walkaround' },
                ],
            },
            jahte: {
                label: 'cat_yachts',
                ...
                itemType: 'plovilo',
                vehicleTypes: [
                    { value: 'Flybridge', label: 'vtype_flybridge' },
                    { value: 'MotornaJahta', label: 'vtype_motor_yacht' },
                    { value: 'Trawler', label: 'vtype_trawler' },
                    { value: 'MegaJahta', label: 'vtype_mega_yacht' },
                ],
            },
        },
    },
    jadrnice: {
        ...
        subcategories: {
            jadrnica: {
                ...
                itemType: 'plovilo',
                vehicleTypes: [
                    { value: 'Enotrupna', label: 'vtype_monohull' },
                    { value: 'Regatna', label: 'vtype_racer' },
                    { value: 'Potovalna', label: 'vtype_cruiser' },
                    { value: 'Motorsailer', label: 'vtype_motorsailer' },
                ],
            },
            katamaran: {
                label: 'cat_catamaran',
                ...
                itemType: 'plovilo',
                vehicleTypes: [
                    { value: 'JadralniKatamaran', label: 'vtype_sail_catamaran' },
                    { value: 'MotorniKatamaran', label: 'vtype_power_catamaran' },
                ],
            },
        },
    },
    gumenjaki: {
        ...
        subcategories: {
            rib: {
                ...
                itemType: 'plovilo',
                vehicleTypes: [
                    { value: 'RibKonzola', label: 'vtype_rib_console' },
                    { value: 'RibBrezKonzole', label: 'vtype_rib_open' },
                ],
            },
            mehki_gumenjak: {
                ...
                itemType: 'plovilo',
                vehicleTypes: [
                    { value: 'TrdoDno', label: 'vtype_hard_bottom' },
                    { value: 'Zlozljiv', label: 'vtype_foldable' },
                ],
            },
        },
    },
    jet_ski: {
        ...
        directSearch: true,
        vehicleTypes: [
            { value: 'SedeciJetSki', label: 'vtype_pwc_runabout' },
            { value: 'StojeciJetSki', label: 'vtype_pwc_standup' },
        ],
    },
    izvenkrmni_motorji: {
