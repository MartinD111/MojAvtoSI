...
function runCalculation() {
  const purchasePrice = parseFormattedNumber(document.getElementById('bbePrice')?.value) || 0;
  const transport     = parseFormattedNumber(document.getElementById('bbeTransport')?.value) || DEFAULTS.transport;
  const homologation  = parseFormattedNumber(document.getElementById('bbeHomologation')?.value) || DEFAULTS.homologation;
  const registration  = parseFormattedNumber(document.getElementById('bbeRegistration')?.value) || DEFAULTS.registration;
            ...
            <div class="bbe-fields">
              ...
              <div class="bbe-field-row">
                ...
                <div class="bbe-field">
                  ...
                  <input id="bbeMileage" type="text" class="js-format-number" placeholder="85,000" inputmode="numeric" />
                </div>
              </div>
              <div class="bbe-field">
                <label>Gorivo</label>
          ...
          <div class="bbe-card glass-card">
            ...
            <div class="bbe-fields">
              <div class="bbe-field">
                ...
                <input id="bbePrice" type="text" class="js-format-number" placeholder="15,000" inputmode="numeric" />
              </div>
              <div class="bbe-field-row">
                <div class="bbe-field">
                  <label>Transport (€)</label>
                  <input id="bbeTransport" type="text" class="js-format-number" value="${formatNumberWithCommas(DEFAULTS.transport)}" inputmode="numeric" />
                </div>
                <div class="bbe-field">
                  <label>Homologacija (€)</label>
                  <input id="bbeHomologation" type="text" class="js-format-number" value="${formatNumberWithCommas(DEFAULTS.homologation)}" inputmode="numeric" />
                </div>
              </div>
              <div class="bbe-field-row">
                <div class="bbe-field">
                  <label>Registracija (€)</label>
                  <input id="bbeRegistration" type="text" class="js-format-number" value="${formatNumberWithCommas(DEFAULTS.registration)}" inputmode="numeric" />
                </div>
                <div class="bbe-field">
                  <label>Marža (%)</label>
